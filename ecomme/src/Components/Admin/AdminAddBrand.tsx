    ...
    <div className="w-full">
      ...
      <div className="bg-[#1E1E2E] border border-gray-700/50 rounded-2xl p-6 w-full">
        <div className="flex flex-col gap-2 mb-5">
          <label
            htmlFor="brand-image"
            className="text-sm font-semibold text-gray-300 underline decoration-blue-400 decoration-1 underline-offset-4 py-2"> Brand image</label>
        ...
        <div className="flex flex-col gap-2 mb-6">
          ...
          <input id="brand-name" type="text" placeholder="Enter brand name"
