      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-3 max-w-xs text-sm text-gray-600">Quality products, fast delivery, and support you can count on.</p>
            <a href={`tel:${PHONE}`}
            ...
            <div className="mt-4 flex items-center gap-3">
              ...
              <a  href="https://x.com/"  target="_blank"  rel="noopener noreferrer"  aria-label="X"  className={socialClass}>
                <svg  viewBox="0 0 24 24"  width="16"  height="16"  fill="currentColor"  aria-hidden="true">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 
                  4.126H5.117z" />
                </svg>
              </a>
              <a  href={`https://wa.me/${PHONE_WA}`}  target="_blank"  rel="noopener noreferrer"  aria-label="WhatsApp"  className={socialClass}>
                <svg  viewBox="0 0 24 24"  width="18"  height="18"  fill="currentColor"  aria-hidden="true">
                  ...
                  1.44h.01c6.53 0 11.84-5.3 11.84-11.84 0-3.16-1.23-6.13-3.37-8.44zM12.05 21.75h-.01a9.9 9.9 0 0 1-5.04-1.38l-.36-.21-3.8 1 1.01-3.7-.24-.38a9.88 9.88 0 
                  0 1-1.51-5.24c0-5.46 4.44-9.9 9.91-9.9 2.64 0 5.12 1.03 6.98 2.9a9.83 9.83 0 0 1 2.9 7c0 5.46-4.45 9.91-9.84 
                  9.91zm5.43-7.41c-.3-.15-1.77-.87-2.04-.97-.27-.1-.47-.15-.67.15-.2.3-.77.97-.94 1.17-.17.2-.35.22-.65.07-.3-.15-1.26-.46-2.4-1.48-.89-.79-1.49-
                  1.77-1.66-2.07-.17-.3-.02-.46.13-.61.13-.13.3-.35.45-.52.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.08-.15-.67-1.62-.92-2.22-.24-.58-.49-.5-.67-
                  .51h-.57c-.2 0-.52.07-.79.37-.27.3-1.04 1.02-1.04 2.48 0 1.46 1.07 2.88 1.22 3.08.15.2 2.1 3.2 5.08 4.49.71.31 1.26.49 1.7.63.71.23 1.36.2
                   1.87.12.57-.08 1.77-.72 2.02-1.42.25-.7.25-1.29.17-1.42-.07-.13-.27-.2-.57-.35z" />
                </svg>
              </a>
            </div>
          </div>
